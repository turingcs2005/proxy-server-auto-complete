...
export const sharedTools = [
	...
	new SharedTools(3, 'front end', 'default value pipe', 'client/src/app/modules/shared/default-value.pipe.ts', 
	'populate default value N/A for a null-valued form control'),
	new SharedTools(4, 'front end', 'snack-bar', 'client/src/app/modules/shared/misce/snack-bar', 
	'pop-up bar at the bottom to display notification for a few seconds'),
	new SharedTools(5, 'front end', 'spinner', 'client/src/app/modules/shared/misce/spinner', 
	'a spinner displaying a message when retrieving data. Use only when response > 2 seconds. Optionally, you may use \
	Angular DevTools to time a request/response cycle'),
